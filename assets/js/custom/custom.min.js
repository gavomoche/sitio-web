    ...
    e(window).on("load", function() {
        ...
        e(document).on("click", ".inner-navigation.show", function(t) {
            ...
            e(this).superslides(e.extend({
                // play: interval of time used to interchange slides, in scientific notation
                play: 4e3,
                animation: "slide",
                animation_speed: 800,
                pagination: !0,
        ...
        e("a", S).on("click", function() {
            ...
            return e(".current", S).removeClass("current"), e(this).addClass("current"), z.isotope({
                filter: t
            }), !1
            ...
            e(this).owlCarousel(e.extend({
                ...
                items: 1,
                loop: 1,
                navText: ["<img src='assets/images/barrow.png'>", "<img src='assets/images/farrow.png'>"]
            }, e(this).data("carousel-options")))
        }), x.each(function() {
            e(this).owlCarousel(e.extend({
                nav: 0,
        ...
        }), e("body").fitVids(), P.find("input,textarea").jqBootstrapValidation({
            preventSubmit: !0,
        ...
        var E = /MSIE 9/i.test(navigator.userAgent) || /rv:11.0/i.test(navigator.userAgent) || /MSIE 10/i.test(navigator.userAgent) || /Edge\/\d+/.test(navigator.userAgent);
        if (1 == E) var W = 1;
        else var W = .4;
        var A = /Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/g.test(navigator.userAgent || navigator.vendor || window.opera);
        A || i.jarallax({
            speed: W
        })
    })
